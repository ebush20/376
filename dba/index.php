...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>" .
             ...
             "<td><a href='https://" . $row["COM_WEBSITE"] . "'</a>" . $row["COM_WEBSITE"] . "</td>" .
             "<td><i class='fas fa-window-close' onclick='deleteCompany(" . $row["COM_ID"] . ")'></i>  <i class='fas fa-edit' onclick='updateCompany(" . $row["COM_ID"] . ")'></i></td>" .
             "</tr>";
    }
} else {
...
?>
            ...
            <i class="fas fa-user-plus" onclick="location.href = 'create.php'"></i> 
    </body>
</html>
